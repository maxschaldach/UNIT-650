  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center overflow-hidden pt-8" style={{ background: 'var(--gradient-radial)' }}>
      ...
      <a 
        ...
        className="mt-16 px-14 py-1 border border-white font-formula font-medium text-white text-sm md:text-sm cursor-pointer transition-all duration-300 active:scale-95 animate-fade-in"
        style={{
          borderRadius: '14px',
