...
const Thesis = () => {
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center overflow-hidden pt-8" style={{ background: 'var(--gradient-radial-light)' }}>
      ...
      />
      <p 
        className="font-formula font-light text-lg md:text-base lg:text-lg text-center px-8 animate-fade-in leading-relaxed"
        style={{ 
          color: '#142318',
      ...
      <nav className="absolute bottom-12 flex gap-6 text-sm md:text-xs font-formula font-light">
        ...
        <Link to="/thesis" style={{ color: '#142318', opacity: 1, transform: 'scaleY(1.4)', display: 'inline-block' }} className="hover:opacity-90 hover:scale-110 transition-all duration-200">
          Thesis
        </Link>
