  ...
  return (
    ...
    >
      ...
      <img
        ...
        className="absolute top-[calc(50%-3px)] -translate-y-1/2 left-4 md:left-8 w-4 h-auto opacity-100 animate-fade-in-subtle cursor-pointer hover:opacity-100 transition-opacity"
      />
      ...
      <img
        ...
        alt="Next"
        onClick={handleNext}
        className="absolute top-[calc(50%-3px)] -translate-y-1/2 right-4 md:right-8 w-4 h-auto opacity-100 animate-fade-in-subtle cursor-pointer hover:opacity-100 transition-opacity"
      />
